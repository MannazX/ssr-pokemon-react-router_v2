...
import { fetchPokemonKanto } from '../../services/pokemonApi';
...
export async function loader(args: any) {
    ...
    try {
        const result = await store.dispatch(fetchPokemonKanto.initiate());
        if (result.error) {
...
export default function KantoPage() {
    ...
    return (
        <div className='container'>
            <h1 className='text-white my-4'>Generation 1 - Kanto Region</h1>
